import sys
import argparse
from accord.amp.evaluatoramp import evaluator

if __name__ == '__main__':

    parser = argparse.ArgumentParser(description='Evaluate an Amp model')
    ...
    parser.add_argument('-ids',
                        ...
                        help="Designated model ids to use for the amp policy.")
